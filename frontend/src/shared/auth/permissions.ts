...
const ROLE_DEFAULT_ACCESS: Record<string, RoleDefaultAccess | "*"> = {
  ...
  ROLE_SUPER_ADMIN: "*",
  PMO_MANAGER: {
    read: ["DASHBOARD", "WORKSPACE", "PROJECTS", "TASKS", "REPORTS", "USERS", "KNOWLEDGE_BASE", "SETTINGS"],
  ...
  TEAM_LEAD: {
    read: ["DASHBOARD", "WORKSPACE", "PROJECTS", "TASKS", "REPORTS", "KNOWLEDGE_BASE", "SETTINGS"],
  ...
  CONTRIBUTOR: {
    read: ["DASHBOARD", "WORKSPACE", "PROJECTS", "TASKS", "KNOWLEDGE_BASE", "SETTINGS"],
    create: ["TASKS"],
    update: ["TASKS"],
  },
  KNOWLEDGE_CURATOR: {
    read: ["DASHBOARD", "PROJECTS", "TASKS", "REPORTS", "KNOWLEDGE_BASE", "SETTINGS"],
