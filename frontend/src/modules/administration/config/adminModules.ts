...
export const adminModuleSpecs: Record<string, AdminModuleSpec> = {
  ...
  "business-units": {
    ...
    backendEndpoint: "/api/admin/organization/business-units",
    listEndpoint: "/api/admin/organization/business-units",
    createEndpoint: "/api/admin/organization/business-units",
    updateEndpoint: "/api/admin/organization/business-units/:id",
    deleteEndpoint: "/api/admin/organization/business-units/:id",
    ...
    fields: [
      ...
      { name: "departmentId", label: "Department", required: false, type: "select", selectEndpoint: "/api/admin/departments", selectResponseKey: "content", selectLabelKey: "departmentName", selectValueKey: "id" },
  ...
  "time-zones": {
    ...
    backendEndpoint: "/api/admin/organization/time-zones",
    listEndpoint: "/api/admin/organization/time-zones",
    createEndpoint: "/api/admin/organization/time-zones",
    updateEndpoint: "/api/admin/organization/time-zones/:id",
    deleteEndpoint: "/api/admin/organization/time-zones/:id",
    listResponseMode: "paged",
    columns: [
      { label: "ID", accessor: "id" },
  ...
  locations: {
    ...
    backendEndpoint: "/api/admin/organization/locations",
    listEndpoint: "/api/admin/organization/locations",
    createEndpoint: "/api/admin/organization/locations",
    updateEndpoint: "/api/admin/organization/locations/:id",
    deleteEndpoint: "/api/admin/organization/locations/:id",
    listResponseMode: "paged",
    columns: [
      { label: "ID", accessor: "id" },
    ...
    fields: [
      ...
      { name: "timezoneId", label: "Time Zone", required: false, type: "select", selectEndpoint: "/api/admin/organization/time-zones", selectResponseKey: "content", selectLabelKey: "timezoneName", selectValueKey: "id" },
      { name: "active", label: "Active", required: true, type: "boolean" },
    ],
    capabilities: fullCapabilities,
  },
  holidays: {
    ...
    backendEndpoint: "/api/admin/organization/holidays",
    listEndpoint: "/api/admin/organization/holidays",
    createEndpoint: "/api/admin/organization/holidays",
    updateEndpoint: "/api/admin/organization/holidays/:id",
    deleteEndpoint: "/api/admin/organization/holidays/:id",
    listResponseMode: "paged",
    columns: [
      { label: "ID", accessor: "id" },
    ...
    fields: [
      ...
      { name: "locationId", label: "Location", required: false, type: "select", selectEndpoint: "/api/admin/organization/locations", selectResponseKey: "content", selectLabelKey: "locationName", selectValueKey: "id" },
  ...
  "audit-logs": {
    ...
    backendEndpoint: "/api/admin/audit-logs",
    listEndpoint: "/api/admin/audit-logs",
    listResponseMode: "paged",
    columns: [
      { label: "ID", accessor: "id" },
      { label: "Entity Type", accessor: "entityType" },
  ...
  "work-logs": {
    ...
    backendEndpoint: "/api/admin/work-logs",
    listEndpoint: "/api/admin/work-logs",
    createEndpoint: "/api/admin/work-logs",
    updateEndpoint: "/api/admin/work-logs/:id",
    deleteEndpoint: "/api/admin/work-logs/:id",
    listResponseMode: "paged",
    columns: [
      { label: "ID", accessor: "id" },
